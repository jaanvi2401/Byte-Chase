...
const Mission4 = ({ onComplete, universeId }) => {
  ...
  return (
    <div className="mission4-page">
      <header className="mission4-header">
        <h1>🔎 Inspect Element</h1>
      </header>

      <div className="mission4-container">
        <div className="mission4-grid">
          <div className="mission4-card">
            <h2>📄 Elements</h2>
          ...
          <div className="mission4-card mission4-network">
            <h2>🌐 Network</h2>
          ...
          <div className="mission4-card mission4-sources">
            <h2>📂 Sources</h2>
        ...
        <div className="mission4-shortcuts">
          <div className="mission4-shortcut">
            <h3>F12</h3>
      ...
      <div className="mission4-submit-overlay">
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          <p style={{ marginBottom: '10px', fontSize: '0.6rem', color: '#00ff66' }}>&gt; LEVEL 4 // SUBMIT KEY:</p>
          <input
            type="text"
            value={inputValue}
